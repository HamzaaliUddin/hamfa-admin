...
export default function AddBannerPage() {
  ...
  return (
    <CrudLayout title="Add New Banner" description="Create a new promotional banner">
            ...
            <CrudFormSection title="Banner Details">
              <div className="space-y-4">
                <div className="grid gap-2">
                  ...
                  <Input id="title" name="title" placeholder="Enter banner title" required />
                </div>

                <div className="grid gap-2">
                  <Label htmlFor="subtitle">Subtitle</Label>
                  <Input id="subtitle" name="subtitle" placeholder="Enter subtitle (optional)" />
                </div>
